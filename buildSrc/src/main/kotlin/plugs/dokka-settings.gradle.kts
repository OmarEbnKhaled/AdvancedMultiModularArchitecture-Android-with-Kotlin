        ...
        dokkaSourceSets {
            ...
            configureEach { // Or source set name, for single-platform the default source sets are `main` and `test`
                ...
                sourceLink {
                    ...
                    remoteUrl.set(
                        java.net.URL(
                            "https://github.com/OmarEbnKhaled/AdvancedMultiModularArchitecture-Android-with-Kotlin"
                        )
                    )
                ...
                externalDocumentationLink {
                    ...
                    url.set(URL("https://github.com/OmarEbnKhaled/AdvancedMultiModularArchitecture-Android-with-Kotlin/docs"))
